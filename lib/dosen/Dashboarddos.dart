...
import 'package:flutter_2020/dosen/adddos.dart';
import 'package:flutter_2020/dosen/updatedos.dart';
          ...
          actions: <Widget>[
            IconButton(
              ...
              onPressed: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => adddos(title: "Input Data Dosen")),
                ).then(onGoBack);
              },
            )
          ],
                ...
                itemBuilder: (context, position) {
                  return Card(
                    //elevation: 8.0,
                      ...
                      child: Container(
                        child: ListTile(
                          title: Text(lDosen[position].nama + " " + lDosen[position].gelar +" - " + lDosen[position].nid),
                                    ...
                                    children: <Widget>[
                                      FlatButton(
                                        ...
                                        onPressed: (){
                                          ...
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => updatedos(title: "Input Data Dosen", dosen:lDosen[position], nidncari: lDosen[position].nidn)),
                                          ).then(onGoBack);
                                        },
                                      ),
                                      Divider(
                                      ...
                                      FlatButton(
                                        child: Text("Delete"),
                                        onPressed: () async{
                                          ApiServices().deleteDosen(lDosen[position].nid);
                                          Navigator.pop(context);
                                          setState(() {});
                                        },
                                      )
