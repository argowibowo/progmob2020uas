...
class UpdateDosen extends StatefulWidget {
  UpdateDosen({Key key, @required this.title, @required this.dsn, @required this.nidncari}) : super(key: key);
  ...
  @override
  _UpdateDosenState createState() => _UpdateDosenState(title, dsn, nidncari);
}
...
class _UpdateDosenState extends State<UpdateDosen> {
  ...
  _UpdateDosenState(this.title, this.dsn, this.nidncari);
