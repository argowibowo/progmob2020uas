...
import 'package:flutter_progmob_2020/jadwal/updatejadwal.dart';
                ...
                itemBuilder: (context, position) {
                  return Card(
                    //elevation: 8.0,
                      ...
                      child: Container(
                        child: ListTile(
                          title: Text(lJadwal[position].matakuliah + " " + lJadwal[position].dosen +" - " + lJadwal[position].sesi),
                                    ...
                                    children: <Widget>[
                                      FlatButton(
                                        ...
                                        onPressed: (){
                                          ...
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => UpdateJadwal(title: "Update Data", id: lJadwal[position].id)),
                                          ).then(onGoBack);
                                        },
                                      ),
                                      Divider(
