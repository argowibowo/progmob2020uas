...
class DashboardJdw extends StatefulWidget {
  DashboardJdw({Key key, this.title}) : super(key: key);
  ...
  @override
  _DashboardJdwState createState() => _DashboardJdwState();
}

class _DashboardJdwState extends State<DashboardJdw> {
