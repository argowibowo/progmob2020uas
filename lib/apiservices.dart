...
import 'package:ronaldo_flutter_progmob_2020/model.dart';
import 'dart:convert';
import 'dart:io';
...
class ApiServices {
  ...
  Future<DashboardSI> getDashboard() async {
    final response = await client.get("$baseUrl/api/progmob/dashboard/72180250");
  ...
  Future<List<Mahasiswa>> getMahasiswa() async {
    final response = await client.get("$baseUrl/api/progmob/mhs/72180250");
    if (response.statusCode == 200) {
  ...
  Future<List<Dosen>> getDosen() async {
    final response = await client.get("$baseUrl/api/progmob/dosen/72180250");
    if (response.statusCode == 200) {
  ...
  Future<List<Matakuliah>> getMatkul() async {
    final response = await client.get("$baseUrl/api/progmob/matkul/72180250");
    if (response.statusCode == 200) {
