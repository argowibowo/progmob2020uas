...
class ApiServices {
  ...
  createwithfoto(Mahasiswa mhs, File imageFile, String path) {}

  updatewithfoto(Mahasiswa mhs, File imageFile, String nimcari) {}

  void deleteMhs(String nim) {}

  getMahasiswa() {}

  createMatkul(Matkul mk) {}

  getDosens() {}

  void deleteDsn(String nidn) {}

  updateDsnWithFoto(Dosen dsn, File imageFile, String nidncari) {}
}
//---------------------dashboard------------------------------------
Future<DashboardSI> getDashboard() async {
    var client;
    final response =
      await client.get("$base64Url/api/progmob/mhs/72180205");
...
Future<List<Mahasiswa>> getMahasiswa() async {
  final response = await client.get("$base64Url/api/progmob/mhs/72180205");
  if(response.statusCode == 200){
...
Future<bool> createMhs(Mahasiswa data) async {
  final response = await client.post(
    "$base64Url/api/progmob/mhs/create",
...
Future<bool> createMhsWithFoto(Mahasiswa data, File file, String filename) async {
  var request = http.MultipartRequest(
      'POST',
      Uri.parse("$base64Url/api/progmob/mhs/createwithfoto")
  );
...
Future<bool> updateMhsWithFoto(Mahasiswa data, File file, String nim_cari) async {
  String is_foto_update = "0";
  var request = http.MultipartRequest(
      'POST',
      Uri.parse("$base64Url/api/progmob/mhs/updatewithfoto")
  );
...
Future<bool> deleteMhs(String nim) async {
  final response = await client.post(
      "$base64Url/api/progmob/mhs/delete",
      headers: {"content-type": "application/json"},
      body: jsonEncode(<String, String>{
        "nim": nim,
        "nim_progmob":"72180205"
      })
  );
...
Future<List<Dosen>> getDosens() async {
  final response = await client.get("$base64Url/api/progmob/dosen/72180205");
  if(response.statusCode == 200){
...
Future<bool> createDsn(Dosen data) async {
  final response = await client.post(
    "$base64Url/api/progmob/dosen/create",
    headers: {"content-type": "application/json"},
...
Future<bool> createDsnWithFoto(Dosen data, File file, String filename) async {
  var request = http.MultipartRequest(
      'POST',
      Uri.parse("$base64Url/api/progmob/dosen/createwithfoto")
  );
...
Future<bool> updateDsnWithFoto(Dosen data, File file, String nidn_cari) async {
  ...
  var request = http.MultipartRequest(
      'POST',
      Uri.parse("$base64Url/api/progmob/dosen/updatewithfoto")
  );
...
Future<bool> deleteDsn(String nidn) async {
  final response = await client.post(
      "$base64Url/api/progmob/dosen/delete",
      headers: {"content-type": "application/json"},
      body: jsonEncode(<String, String>{
        "nidn": nidn,
        "nim_progmob":"72180205"
...
Future<List<Matkul>> getMatkuls() async {
  final response = await client.get("$base64Url/api/progmob/matkul/72180205");
  if(response.statusCode == 200){
...
Future<bool> createMatkul(Matkul data) async {
  final response = await client.post(
    "$base64Url/api/progmob/matkul/create",
    headers: {"content-type": "application/json"},
...
Future<bool> updateMatkul(Matkul data, String kode_cari) async {
  var request = http.MultipartRequest(
      'POST',
      Uri.parse("$base64Url/api/progmob/matkul/update")
  );
...
Future<bool> deleteMatkul(String kode) async {
  final response = await client.post(
      "$base64Url/api/progmob/matkul/delete",
      headers: {"content-type": "application/json"},
      body: jsonEncode(<String, String>{
        "kode": kode,
        "nim_progmob":"72180205"
