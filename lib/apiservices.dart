...
class ApiServices {
  ...
  // dashboard
  Future<DashboardHH> getDashboard() async{
    final response = await client.get("$baseUrl/api/progmob/dashboard/72180256");
    if (response.statusCode == 200){
      return DashboardHH.fromJson(json.decode(response.body));
    } else {
      return null;
    }
  }
  ...
  Future<List<Mahasiswa>> getMahasiswas() async {
    final response = await client.get("$baseUrl/api/progmob/mhs/72180256");
    if (response.statusCode == 200) {
  ...
  Future<List<Dosen>> getDosen() async {
    final response = await client.get("$baseUrl/api/progmob/dosen/72180256");
    if (response.statusCode == 200) {
  ...
  Future<List<Matakuliah>> getMatkul() async {
    final response = await client.get("$baseUrl/api/progmob/matkul/72180256");
    if (response.statusCode == 200) {
  ...
  Future<List<Jadwal>> getJadwal() async {
    final response = await client.get("$baseUrl/api/progmob/jadwal/72180256");
    if (response.statusCode == 200) {
