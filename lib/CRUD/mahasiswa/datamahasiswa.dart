          ...
          child: Column(
            ...
            children: <Widget>[
              ListTile(
                ...
                title: Text("Brigita Monic"),
                subtitle: Text("72180221"),
              ...
              ListTile(
                leading: Icon(Icons.person),
                title: Text("Modesta Oki"),
                subtitle: Text("72180208"),
                trailing: PopupMenuButton(
                  itemBuilder: (_) => <PopupMenuItem<String>>[
                    new PopupMenuItem<String>(
                      child: const Text('Update'), value: 'Update',
              ...
              ListTile(
                leading: Icon(Icons.person),
                title: Text("Debora Milea"),
                subtitle: Text("72180207"),
                trailing: PopupMenuButton(
                  itemBuilder: (_) => <PopupMenuItem<String>>[
                    new PopupMenuItem<String>(
                      child: const Text('Update'), value: 'Update',
