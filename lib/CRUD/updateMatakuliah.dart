...
class UpdateMatakuliah extends StatefulWidget {
  ...
  Matakuliah matkul;
  String kodecari;
  UpdateMatakuliah({Key key, @required this.title, @required this.matkul, @required this.kodecari}) : super(key: key);

  @override
  _UpdateMatakuliahState createState() => _UpdateMatakuliahState(title, matkul, kodecari);
}
...
class _UpdateMatakuliahState extends State<UpdateMatakuliah> {
  ...
  _UpdateMatakuliahState(this.title, this.matkul, this.kodecari);
                              ...
                              actions: <Widget>[
                                FlatButton(
                                    onPressed: () async {
                                      ...
                                      this.matkul.nim_progmob = "72180234";
