...
class TambahMatakuliah extends StatefulWidget {
  TambahMatakuliah({Key key, @required this.title}) : super(key: key);
  final String title;

  @override
  _TambahMatakuliahState createState() => _TambahMatakuliahState(title);
}

class _TambahMatakuliahState extends State<TambahMatakuliah> {
  final GlobalKey<FormState> _formState = GlobalKey<FormState>();
  final String title;
  _TambahMatakuliahState(this.title);
                              ...
                              actions: <Widget>[
                                FlatButton(
                                    onPressed: () async {
                                      ...
                                      this.matakuliah.nim_progmob = "72180234";
