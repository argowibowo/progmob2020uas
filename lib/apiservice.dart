...
class ApiServices {
  ...
  // ------------------------------dashboard------------------------------
  Future<DashboardRS> getDashboard() async {
    final response = await client.get("$baseUrl/api/progmob/dashboard/72180239");
    if (response.statusCode == 200) {
      return DashboardRS.fromJson(json.decode(response.body));
    } else {
      return null;
    }
  }
  ...
  Future<List<Mahasiswa>> getMahasiswa() async {
    final response = await client.get("$baseUrl/api/progmob/mhs/72180239");
    if (response.statusCode == 200) {
  ...
  Future<List<Dosen>> getDosen() async {
    final response = await client.get("$baseUrl/api/progmob/dosen/72180239");
    if (response.statusCode == 200) {
  ...
  Future<List<Matakuliah>> getMatkul() async {
    final response = await client.get("$baseUrl/api/progmob/matkul/72180239");
    if (response.statusCode == 200) {
