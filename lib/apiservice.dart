...
class ApiServices{
  ...
  Future<DashboardSI> getDashboard() async {
    final response = await client.get("$baseUrl/api/progmob/dashboard/72180247");
  ...
  Future<List<Mahasiswa>> getMahasiswa() async{
    final response = await client.get("$baseUrl/api/progmob/mhs/72180247");
    if (response.statusCode == 200){
...
//-----------------------Dosen-----------------------------------------------
  Future<List<Dosen>> getDosen() async {
    final response = await client.get("$baseUrl/api/progmob/dosen/72180247");
    if (response.statusCode == 200) {
...
//----------------------------Matakuliah-------------------------------------
  ...
  Future<List<Matakuliah>> getMatkul() async {
    final response = await client.get("$baseUrl/api/progmob/matkul/72180247");
    if (response.statusCode == 200) {
