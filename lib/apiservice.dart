...
//---------------- dosen------------------------------------------
  ...
  Future<bool> updateDsnlWithFoto(Dosen data, File file, String nidnCari) async{
    String isfotoupdate = "0";
    var request = http.MultipartRequest(
        'POST',
...
/*Future<ModelSi> getDashboard() async{
  ...
  Future<List<Matakuliah>> getMatakuliah() async{
    final response = await client.get("$baseUrl/api/progmob/matakuliah/72180237");
    if (response.statusCode == 200){
  ...
  Future<bool> createMatkulWithFoto(Mahatakuliah data, File file, String filename) async{
    var request = http.MultipartRequest(
        'POST',
  ...
  Future<bool> updateMatkulWithFoto(Matakuliah data, File file, String kodeMatakuliahCari) async{
    String isfotoupdate = "0";
    var request = http.MultipartRequest(
        'POST',
    ...
    request.fields.addAll({
      ...
      "dosen":data.dosen,
      "nim_progmob":data.nim_progmob,
      "kodeMatakuliah_cari":kodeMatakuliahCari,
      "is_foto_update":isfotoupdate
    }
    );
    var response = await request.send();
  ...
  Future<bool> deleteMatkul(String kodeMatkul) async{
    final response = await client.post(
