...
class UpdateMhs extends StatefulWidget {
  ...
  @override
  UpdateMhsState createState() => UpdateMhsState(title, mhs, nimcari);
}

class UpdateMhsState extends State<UpdateMhs> {
  ...
  UpdateMhsState(this.title, this.mhs, this.nimcari);
