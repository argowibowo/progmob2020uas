...
class UpdateMatakuliah extends StatefulWidget{
  ...
  UpdateMatakuliah({Key key, @required this.title, @required this.mtk, @required this.kodecari}) : super(key: key);

  @override
  _UpdateMatakuliahState createState() => _UpdateMatakuliahState(title, mtk, kodecari);
}
...
class _UpdateMatakuliahState extends State<UpdateMatakuliah>{
  ...
  _UpdateMatakuliahState(this.title, this.mtk, this.kodecari);
