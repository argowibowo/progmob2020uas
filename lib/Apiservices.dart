import 'dart:convert';
import 'dart:io';
import 'package:flutter_progmob_2020/Dosen/dbdosen.dart';
...
class ApiServices {
  ...
  // dashboard
  Future<DashboardSat> getDashboard() async{
    final response = await client.get("$baseUrl/api/progmob/dashboard/72180248");
    if (response.statusCode == 200){
      return DashboardSat().fromJson(json.decode(response.body));
    } else {
      return null;
    }
  }
  ...
  Future<List<Mahasiswa>> getMahasiswas() async {
    final response = await client.get("$baseUrl/api/progmob/mhs/72180248");
    if (response.statusCode == 200) {
  ...
  Future<List<Dosen>> getDosen() async {
    final response = await client.get("$baseUrl/api/progmob/dosen/72180248");
    if (response.statusCode == 200) {
  ...
  Future<List<Matakuliah>> getMatkul() async {
    final response = await client.get("$baseUrl/api/progmob/matkul/72180248");
    if (response.statusCode == 200) {
  ...
  Future<List<Jadwal>> getJadwal() async {
    final response = await client.get("$baseUrl/api/progmob/jadwal/72180248");
    if (response.statusCode == 200) {
