...
class ClicksPerYear {
  ...
  ClicksPerYear(this.year, this.clicks, charts.Color color)
...
class Mahasiswa {
  ...
  factory Mahasiswa.fromJson(Map<String, dynamic> map) {
    return Mahasiswa(id: map['id'], nama: map['nama'], nim: map['nim'], alamat: map['alamat'], email: map['email'], foto: map['foto'], nim_progmob: map['nim_progmob']);
  }
