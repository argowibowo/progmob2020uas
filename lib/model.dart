...
class Matkul{
  ...
  //konstruktor
  Matkul({this.id, this.kode, this.nama, this.hari, this.sks, this.nim_progmob});
  ...
  Map<String, dynamic> toJson(){
    return{"id": id, "kode": kode, "nama": nama, "hari": hari,  "sks": sks, "nim_progmob": nim_progmob};
  }

  @override
  String toString() {
    return 'Matkul{id: $id, kode: $kode, nama: $nama, hari: $hari,  sks: $sks, nim_progmob: $nim_progmob}';
  }
}
