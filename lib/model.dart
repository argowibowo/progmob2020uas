...
class Mahasiswa {
  ...
  factory Mahasiswa.fromJson(Map<String, dynamic> map) {
    return Mahasiswa(id: map["id"], nama: map["nama"], nim: map["nim"],
      alamat: map["alamat"], email: map["email"], foto: map["foto"],
  ...
  @override
  String toString() {
    return 'Mahasiswa{id: $id, nama: $nama, nim: $nim, alamat: $alamat,'
...
class Matakuliah {
  ...
  Matakuliah({this.kodeMatakuliah, this.hari, this.sesi, this.dosen, this.nama,
      this.jmlhMhs, this.sks, this.nim_progmob});
  
  factory Matakuliah.fromJson(Map<String, dynamic> map) {
    return Matakuliah(kodeMatakuliah: map["kode"],
      hari: map["hari"],
      sesi: map["sesi"],
      dosen: map["dosen"],
      nama: map["nama"],
  ...
  Map<String, dynamic> toJson() {
    return {"kodeMatakuliah": kodeMatakuliah, "hari": hari, "sesi": sesi, "dosen": dosen, "nama": nama,
      "jmlhMhs": jmlhMhs, "sks": sks, "nim_progmob": nim_progmob};
  }
}
...
class Dosen {
  ...
  @override
  String toString() {
    return 'Dosen{id: $id, nama: $nama, nidn: $nidn, alamat: $alamat, email: $email,'
...
class Jadwal {
  ...
  Jadwal({this.id, this.matakuliah, this.dosen, this.nidn, this.hari, this.sesi,
    this.sks});
  ...
  @override
  String toString() {
    return 'Jadwal{id: $id, matakuliah: $matakuliah, dosen: $dosen, nidn: $nidn, hari: $hari,'
        'sesi: $sesi, sks: $sks}';
  }
}
...
String jadwalToJson(Dosen data) {
  final jsonData = data.toJson();
  return json.encode(jsonData);
}
