...
import 'package:flutter_app/Jadwal/update.dart';
import 'package:flutter_app/model.dart';
import 'package:flutter_app/apiservices.dart';

class Jadwaldb extends StatefulWidget {
  Jadwaldb({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _JadwaldbState createState() => _JadwaldbState();
}

class _JadwaldbState extends State<Jadwaldb> {
