...
class tambahDosen extends StatefulWidget {
  tambahDosen({Key key, @required this.title}) : super(key: key);
  final String title;

  @override
  _tambahDosenState createState() => _tambahDosenState(title);
}

class _tambahDosenState extends State<tambahDosen> {
  final GlobalKey<FormState> _formState = GlobalKey<FormState>();
  final String title;
  _tambahDosenState(this.title);
