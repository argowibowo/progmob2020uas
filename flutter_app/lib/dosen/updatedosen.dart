...
class UpdateDosen extends StatefulWidget {
  ...
  UpdateDosen({Key key, @required this.title, @required this.dosen, @required this.nikcari}) : super(key: key);

  @override
  _UpdateDosenState createState() => _UpdateDosenState(title, dosen, nikcari);
}

class _UpdateDosenState extends State<UpdateDosen> {
  final GlobalKey<FormState> _formState = GlobalKey<FormState>();
  final String title;
  final String nikcari;
  Dosen dosen;
  bool isLoading = false;
  File _imageFile;

  _UpdateDosenState(this.title, this.dosen, this.nikcari);
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      initialValue: this.dosen.nik,
                      onSaved: (String value) {
                        this.dosen.nik = value;
                      },
                    ),
                    SizedBox(height: 15,
                    ),
                              ...
                              actions: <Widget>[
                                FlatButton(
                                    onPressed: () async {
                                      ...
                                      this.dosen.nim_progmob = "72170142";
                                      ApiServices().updateDosenWithFoto(this.dosen, _imageFile, nikcari).then((isSuccess) {
