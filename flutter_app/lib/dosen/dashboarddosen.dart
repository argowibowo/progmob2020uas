...
import 'package:flutter_app/dosen/updatedosen.dart';
import 'package:flutter_app/model.dart';
import 'tambahdosen.dart';
                ...
                return Card(
                  ...
                  child: Container(
                    child: ListTile(
                      ...
                      subtitle: Text(listDosen[position].nik + " - " + listDosen[position].email),
                            ...
                            builder: (_) => AlertDialog(
                              content: Column(
                                ...
                                children: <Widget>[
                                      ...
                                      onPressed: (){
                                        ...
                                        Navigator.push(
                                            ...
                                            MaterialPageRoute(builder: (context) => UpdateDosen(title: "Update Data Dosen",
                                                ...
                                                nikcari: listDosen[position].nik))
                                        ).then(onGoBack);
                                      },
                                      child: Text("Update")
                                  ),
                                  ...
                                  FlatButton(
                                      onPressed: () async {
                                        ApiServices().deleteDosen(listDosen[position].nik);
                                        Navigator.pop(context);
                                        setState(() {
