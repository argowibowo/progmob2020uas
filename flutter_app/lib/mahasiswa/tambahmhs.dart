...
class tambahMhs extends StatefulWidget {
  tambahMhs({Key key, @required this.title}) : super(key: key);
  final String title;

  @override
  _tambahMhsState createState() => _tambahMhsState(title);
}

class _tambahMhsState extends State<tambahMhs> {
  final GlobalKey<FormState> _formState = GlobalKey<FormState>();
  final String title;
  _tambahMhsState(this.title);
