...
class ApiServices {
  ...
  Future<DashboardSI> getDashboard() async {
    final response = await client.get("$baseUrl/api/progmob/dashboard/72170142");
  ...
  Future<List<Mahasiswa>> getMahasiswa() async {
    final response = await client.get("$baseUrl/api/progmob/mhs/72170142");
    if (response.statusCode == 200) {
  ...
  Future<bool> createMhsWithFoto(Mahasiswa data, File file, String filename) async {
    var request = http.MultipartRequest(
        'POST',
        Uri.parse("$baseUrl/api/progmob/mhs/createwithfot")
    );
  ...
  Future<List<Dosen>> getDosen() async {
    final response = await client.get("$baseUrl/api/progmob/dosen/72170142");
    if (response.statusCode == 200) {
  ...
  Future<bool> updateDosenWithFoto(Dosen data, File file, String nik_cari) async {
    String isFotoUpdate = "0";
  ...
  Future<bool> deleteDosen(String nik) async {
    final response = await client.post(
  ...
  Future<List<Matakuliah>> getMatkul() async {
    final response = await client.get("$baseUrl/api/progmob/matkul/72170142");
    if (response.statusCode == 200) {
