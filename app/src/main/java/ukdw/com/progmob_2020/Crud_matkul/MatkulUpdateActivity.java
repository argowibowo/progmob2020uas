...
public class MatkulUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText edkodelama = (EditText)findViewById(R.id.editkodemklama);
        final EditText ednama = (EditText)findViewById(R.id.editnamamk);
        final EditText edkode = (EditText)findViewById(R.id.editkodemk);
        final EditText edhari = (EditText)findViewById(R.id.editharimk);
        final EditText edsks = (EditText)findViewById(R.id.editsksmk);
        final EditText edsesi = (EditText)findViewById(R.id.editsesimk);
