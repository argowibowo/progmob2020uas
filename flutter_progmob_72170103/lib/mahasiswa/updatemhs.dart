...
class UpdateMhs extends StatefulWidget {
  ...
  UpdateMhs({Key key, @required this.title, @required this.mhs, @required this.nim_cari}) : super(key: key);

  @override
  _UpdateMhsState createState() => _UpdateMhsState(title, mhs, nim_cari);
}

class _UpdateMhsState extends State<UpdateMhs> {
  final GlobalKey<FormState> _formState = GlobalKey<FormState>();
  final String title;
  final String nim_cari;
  Mahasiswa mhs;
  bool isLoading = false;
  File _imageFile;

  _UpdateMhsState(this.title, this.mhs, this.nim_cari);
                              ...
                              actions: <Widget>[
                                FlatButton(
                                    onPressed: () async {
                                      ...
                                      this.mhs.nim_progmob = "72170103";
                                      // List<int> imageByte = _imageFile.readAsBytesSync();
                                      // this.mhs.foto = base64Encode(imageByte);
                                      ApiServices().updateMhsWithFoto(this.mhs, _imageFile, nim_cari).then((isSuccess) {
